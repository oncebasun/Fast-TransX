...
void prepare()
{
  FILE* f1 = fopen("/data/disk1/private/jinhuiming/FB15K/entity2id.txt","r");
	FILE* f2 = fopen("/data/disk1/private/jinhuiming/FB15K/relation2id.txt","r");
	int x;
  int temp;
  fscanf(f1,"%d",&temp);
  fscanf(f2,"%d",&temp);
    ...
    FILE* f_kb = fopen("/data/disk1/private/jinhuiming/FB15K/test.txt","r");
    ...
    fclose(f_kb);
    FILE* f_kb1 = fopen("/data/disk1/private/jinhuiming/FB15K/train.txt","r");
    ...
    fclose(f_kb1);
    FILE* f_kb2 = fopen("/data/disk1/private/jinhuiming/FB15K/valid.txt","r");
